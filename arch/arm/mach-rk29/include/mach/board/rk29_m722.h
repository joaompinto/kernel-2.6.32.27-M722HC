...
#define WIFI_EXT_POWER			RK29_PIN6_PB3
...
#define	CHARGE_MID_SECOND	            180	//time interval for charging 1% battery when battery capacity over 80%
